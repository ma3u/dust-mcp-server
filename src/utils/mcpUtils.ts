 ...
 */
export function validateMcpRequest(request: unknown): { valid: boolean; error?: string } {
 ...
 */
export function logSystemPattern(pattern: string, data: Record<string, unknown>): void {
  try {
